...
# the restaurant name variable alongside the data is called a string. The name of my restaurant comes from my parents' and my initials.
...
#popular_item_price = 150
# the popular item price variable alongside the data is called an integer.
#display(f"Popular Item Price: ₱{popular_item_price}")

#has_delivery = True
# the has delivery variable alongside the data is called a boolean.
#display(f"Has Delivery: {has_delivery}")
